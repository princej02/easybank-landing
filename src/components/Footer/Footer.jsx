...
export const Logo = () => {
  return (
    ...
    >
      ...
      </defs><g fill="none" fillRule="evenodd">
    ...
    <footer className="app__footer section__padding">
      <div className="app__footer-content">
        <div className="app__footer-content-left">
          <div className="app__footer_social-section">
            <Logo />
            <ul className="app__footer-socials">
              <li><a href="https://www.facebook.com/"><img className='icon' src={icon.facebook} alt="facebook" /></a></li>
              <li><a href="/"><img className='icon' src={icon.youtube} alt="youtube" /></a></li>
              <li><a href="/"><img className='icon' src={icon.twitter} alt="twitter" /></a></li>
              <li><a href="/"><img className='icon' src={icon.pinterest} alt="pinterest" /></a></li>
              <li><a href="/"><img className='icon' src={icon.instagram} alt="instagram" /></a></li>
            </ul>
          </div>
